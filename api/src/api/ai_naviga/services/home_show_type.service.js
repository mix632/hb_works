...
const repo = require('../dal/biz_home_show_type.repo');
const model = require('../model/biz_home_show_type.model');
const dto = require('../dto/biz_home_show_type.dto');
const util = require('../../../utils');
const config = require('../../../core/serverConfig');
const serviceRegistry = require('../../../core/serviceRegistry');

class HomeShowTypeService extends BaseService {
  constructor() {
    super({ service: repo, model, prefix: '/ai_naviga/home_show_type', dto });
  }
...
module.exports = new HomeShowTypeService();