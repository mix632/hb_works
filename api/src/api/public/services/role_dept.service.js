...
const repo = require('../dal/sys_role_dept.repo');
const model = require('../model/sys_role_dept.model');
const dto = require('../dto/sys_role_dept.dto');
const util = require('../../../utils');
const config = require('../../../core/serverConfig');
const serviceRegistry = require('../../../core/serviceRegistry');

class RoleDeptService extends BaseService {
  constructor() {
    super({ service: repo, model, prefix: '/public/role_dept', dto });
  }
...
module.exports = new RoleDeptService();