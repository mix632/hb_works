...
const repo = require('../dal/sys_area_code.repo');
const model = require('../model/sys_area_code.model');
const dto = require('../dto/sys_area_code.dto');
...
class AreaCodeService extends BaseService {
  constructor() {
    super({ service: repo, model, prefix: '/public/area_code', dto });
  }
...
module.exports = new AreaCodeService();