...
const repo = require('../dal/sys_flow_config.repo');
const model = require('../model/sys_flow_config.model');
const dto = require('../dto/sys_flow_config.dto');
const util = require('../../../utils');
const config = require('../../../core/serverConfig');
const serviceRegistry = require('../../../core/serviceRegistry');

class FlowConfigService extends BaseService {
  constructor() {
    super({ service: repo, model, prefix: '/public/flow_config', dto });
  }
...
module.exports = new FlowConfigService();