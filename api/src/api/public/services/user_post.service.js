...
const repo = require('../dal/sys_user_post.repo');
const model = require('../model/sys_user_post.model');
const dto = require('../dto/sys_user_post.dto');
...
class UserPostService extends BaseService {
  constructor() {
    super({ service: repo, model, prefix: '/public/user_post', dto });
  }
...
module.exports = new UserPostService();